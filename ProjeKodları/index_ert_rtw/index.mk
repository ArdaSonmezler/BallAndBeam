###########################################################################
## Makefile generated for Simulink model 'index'. 
## 
## Makefile     : index.mk
## Generated on : Thu Mar 12 14:59:22 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/index.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/PROGRA~1/MATLAB/Proje
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = index_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/index.elf
...
DEFINES_ = -DMODEL=index -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
DEFINES_STANDARD = -DMODEL=index -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : C:/Users/berat/DOCUME~1/MATLAB/Add-Ons/COLLEC~1/RENSSE~1/code/HURSTJ~1/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/Users/berat/DOCUME~1/MATLAB/Add-Ons/COLLEC~1/RENSSE~1/code/HURSTJ~1/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/Users/berat/DOCUME~1/MATLAB/Add-Ons/COLLEC~1/RENSSE~1/code/HURSTJ~1/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/index_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/index_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
io_wrappers.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
Servo.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/Servo/src/avr/Servo.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
