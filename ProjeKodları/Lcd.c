 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Mar 07 14:36:53 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Lcd
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        char_val
...
{
    const uint16_T *char_val = (uint16_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    Lcd_Outputs_wrapper(char_val, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Lcd_Update_wrapper(char_val, xD);
